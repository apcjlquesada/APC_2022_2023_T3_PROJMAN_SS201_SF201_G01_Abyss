...
<div class="container my-2">
  <ul class="nav nav-tabs">
    ...
    <li class="nav-item">
      <a class="nav-link" href="{{ URL::to('teacher/project/' . $group_projects->id . '/task') }}">{{ __('Taskboard') }}</a>
    </li>
    <li class="nav-item">
  ...
  <div class="row row-cols-1 row-cols-md-2 g-4 my-2">
    @include('teacher.post', ['projects' => $group_projects->projects, 'group_project_id' => $group_projects->id])
  </div>
</div>
